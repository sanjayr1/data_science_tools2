...
** June 3 rd
  ...
  [[./notebooks/kaggle_bike_rental_v2.ipynb][kaggle_bike_rental_v2 in class version]]
...
|-------------+---------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3 rd June   | [[https://github.com/awslabs/amazon-sagemaker-examples][AWS lab sagemaker examples]]            | Improved RMSLE for bike sharing using hour and log of counts(target). Training in the cloud.                                                            |
|             |                                       | Invoking model endpoint outside sagemaker notebook instance.                                                                                            |
|-------------+---------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 th June   |                                       | In class 8 minutes presentation.                                                                                                                        |
|-------------+---------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------|
|             |                                       |                                                                                                                                                         |
