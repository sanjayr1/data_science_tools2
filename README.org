...
*** Project proposal via github link(not graded). Any team member can submit this.
Main focus in tools 2 is building predictive models.
...
|-----------+--------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------|
| 8 t April |                                      | feature selection method, filter , wrapper, embedded,                                                                                                   |
