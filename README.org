...
We'll allow 2 late homework with cutoff of 36 hours. We'll subtract *ceil(total_marks*exp(-(minutes late)/(24*60)))* marks from total marks for the assignments for late submissions via email.
